...
<body>
  <div class="container">
    ...
    if ($results['individu']['pere']==0)
        ...
        echo ("<li>Père <a href='router2.php?action=individuPage&id=".$results['individu']['pere']."'>".$results['individu']['pere_nom']." ".$results['individu']['pere_prenom']."</a></li>");
    if ($results['individu']['mere']==0)
        echo ("<li>Mère ?</li>");
    else
        echo ("<li>Mère <a href='router2.php?action=individuPage&id=".$results['individu']['mere']."'>".$results['individu']['mere_nom']." ".$results['individu']['mere_prenom']."</a></li>");
    echo ("</ul>");
